...
import com.zyl.sercurity.properties.SecurityConstants;
...
public class BrowserSecurityController {
    ...
    public ErrorResponse requireAuthenication(HttpServletRequest request, HttpServletResponse response) throws IOException {
